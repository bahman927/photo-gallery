...
const PhotoCarousel = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      {/* --- Main Display --- */}
      <div className="relative w-full sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-1/2 aspect-video mb-4 overflow-hidden rounded-xl shadow-lg">
        ...
        <button
          onClick={handlePrev}
          className="absolute top-1/2 left-2 -translate-y-1/2 bg-gray-800/50 hover:bg-gray-900/70 text-white p-3 rounded-full transition"
        >
        ...
        <button
          onClick={handleNext}
          className="absolute top-1/2 right-2 -translate-y-1/2 bg-gray-800/50 hover:bg-gray-900/70 text-white p-3 rounded-full transition"
        >
